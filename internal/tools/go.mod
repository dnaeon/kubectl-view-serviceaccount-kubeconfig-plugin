module github.com/superbrothers/kubectl-view-serviceaccount-kubeconfig-plugin/internal/tools
...
tool (
	...
	github.com/t0yv0/goreleaser-filter
	sigs.k8s.io/krew/cmd/validate-krew-manifest
)
...
require (
	...
	github.com/t0yv0/goreleaser-filter v0.3.0 // indirect
	...
	sigs.k8s.io/krew v0.5.0 // indirect
